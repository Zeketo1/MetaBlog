  ...
  return (
    <>
      <div className="relative h-[250px] sm:h-[300px] md:h-[350px] lg:h-[480px] w-full bg-bannerBg2 bg-no-repeat bg-cover flex items-end mb-[90px]">
        ...
        <div className={`p-4 sm:p-7 transition duration-500 ${dark ? "bg-[#242535] text-white" : "bg-white"}  shadow-lg rounded-md translate-y-10 translate-x-10 w-[300px] sm:w-[350px] flex flex-col gap-2`}>
          ...
          <div className="flex items-center text-[13px] gap-2 justify-around">
            <div className="w-[40px] h-[35px] sm:h-[40px] bg-blue-900 rounded-[50%] text-white flex justify-center items-center">J</div>
            <p>Jason Francisco</p>
            <p>2024-08-03</p>
          </div>
        </div>
